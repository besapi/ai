...
1. کتاب "Deep Learning for Medical Image Analysis" اثر S. Kevin Zhou و غیره، این کتاب یک مرجع کامل برای استفاده از یادگیری عمیق در تصاویر پزشکی است.

2. Coursera دوره‌ای با عنوان "AI for Medicine" دارد که توسط دانشگاه کالیفرنیا، ایرواین ارائه شده است. این دوره شامل سه بخش است: آشنایی با تشخیص بیماری، پیش‌بینی آن و برنامه‌ریزی درمان.

3. Fast.ai یک دوره یادگیری عمیق رایگان ارائه می‌دهد که تمرکز خاصی بر روی پروژه‌های عملی دارد.
...
3. **آشنایی با کتابخانه‌های پایتون مرتبط با داده‌کاوی**
...
5. **آشنایی با کتابخانه‌های یادگیری عمیق**
